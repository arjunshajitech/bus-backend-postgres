...
public class AppConfig {
    ...
    public void storeDefaultAdmin() {
        ...
        userList.add(new User("Admin", "Admin", null, "admin@admin.com", PasswordEncoder.encodePassword("Password@1"),
                UserRole.ADMIN));
        userList.add(new User("Super", "Admin", null, "superadmin@admin.com", PasswordEncoder.encodePassword("Password@1"),
                UserRole.ADMIN));
